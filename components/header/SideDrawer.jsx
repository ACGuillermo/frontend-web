const SideDrawer = ({click, show}) =>{
    ...
    return (
        <nav className={drawerClasses}>
            <button onClick={click} className="relative top-0 right-0 mt-4 mr-4 fill-current text-teal-400 focus:outline-none">
            ...
            <ul className="text-teal-400 mt-24 ml-8 text-lg">
